        ...
        <div class="row">
            ...
            <div class="col-12">
                <div class="card-group">
                    <div class="card">
                        <img src="img\padded-1.jpg" class="card-img-top pt-3 pb-1" alt="...">
                        <div class="card-body">
                        <h5 class="card-title">ซองกันกระแทก ซี 5 <br> Padded Envelope C5</h5>
                    ...
                    <div class="card">
                        <img src="img\padded-3.jpg" class="card-img-top" alt="...">
                        <div class="card-body">
                        <h5 class="card-title">ซองกันกระแทก ซี 4 ชนิดแยกจําหน่าย <br> Padded Envelope C4 (Single)</h5>
                        <p class="card-text">249 x 324 มม./mm. </p>
                        </div>
                        <div class="card-footer">
                        <small class="text-muted">17.00 บาท</small>
                        </div>
                    </div>
                    <div class="card">
                        <img src="img\padded-3.jpg" class="card-img-top pb-2" alt="...">
                        <div class="card-body">
                        <h5 class="card-title">ซองกันกระแทก ซี 4 ชนิดจําหน่ายเป็นแพค (1 แพค เท่ากับ 5 ซอง)<br> Padded Envelope C4 (Pack) (1 Pack = 5 Envelope)</h5>
                        <p class="card-text">249 x 324 มม./mm </p>
                        </div>
                        <div class="card-footer">
                        <small class="text-muted">80.00 บาท</small>
                        </div>
                    </div>
                    <div class="col">
                    </div>
