        ...
        <div class="row">
            ...
            <div class="col-12">
                <div class="card-group">
                    <div class="card">
                        <img src="img\box-1.jpg" class="card-img-top" alt="...">
                        <div class="card-body">
                        <h5 class="card-title">กล่องสําเร็จรูปแบบ ก <br> Ready-Made Carton type A</h5>
                        <p class="card-text">14 x 20 x 6 ซม. / cm.</p>
                        </div>
                        <div class="card-footer">
                        <small class="text-muted">9.00 บาท</small>
                        </div>
                    </div>
                    <div class="card">
                        <img src="img\box-2.jpg" class="card-img-top" alt="...">
                        <div class="card-body">
                        <h5 class="card-title">กล่องสําเร็จรูปแบบ ข. <br> Ready-Made Carton type B</h5>
                        <p class="card-text">17 x 25 x 9 ซม./ cm</p>
                        </div>
                        <div class="card-footer">
                        <small class="text-muted">12.00 บาท</small>
                        </div>
                    </div>
                    <div class="card">
                        <img src="img\box-3.jpg" class="card-img-top " alt="...">
                        <div class="card-body">
                        <h5 class="card-title">กล่องสําเร็จรูปแบบ ค.<br> Ready-Made Carton type</h5>
                        <p class="card-text">20 x 30 x 11 ซม./ cm.</p>
                        </div>
                        <div class="card-footer">
                        <small class="text-muted">16.00 บาท</small>
                        </div>
                    </div>
                    <div class="card">
                        <img src="img\box-4.jpg" class="card-img-top" alt="...">
                        <div class="card-body">
                        <h5 class="card-title">กล่องสําเร็จรูปแบบ ง.<br> Ready-Made Carton type D

                        </h5>
                        <p class="card-text">22 x 35 x 14 ซม./ cm </p>
                        </div>
                        <div class="card-footer">
            ...
            <div class="col-12">
                <div class="card-group">
                    <div class="card">
                        <img src="img\box-5.jpg" class="card-img-top" alt="...">
                        <div class="card-body">
                        <h5 class="card-title">กล่องสําเร็จรูปแบบ จ. <br>Ready-Made Carton type E</h5>
                        <p class="card-text">24 x 40 x 17 ซม./ cm. </p>
                        </div>
                        <div class="card-footer">
                        <small class="text-muted">25.00 บาท</small>
                        </div>
                    </div>
                    <div class="card">
                        <img src="img\box-6.jpg" class="card-img-top pt-5 pb-4" alt="...">
                        <div class="card-body">
                        <h5 class="card-title">กล่องสําเร็จรูปแบบ ฉ.<br>Ready-Made Carton type F</h5>
                        <p class="card-text">30 x 45 x 20 ซม./ cm.</p>
                        </div>
                        <div class="card-footer">
                        <small class="text-muted">32.00 บาท</small>
                        </div>
                    </div>
                    <div class="col">
