        ...
        <div class="row">
            ...
            <div class="col-12">
                <div class="card-group">
                    <div class="card">
                        <img src="img\epe-1.jpg" class="card-img-top " alt="...">
                        <div class="card-body">
                        <h5 class="card-title">วัสดุกันกระแทกแบบ EPE Foam</h5>
                        <p class="card-text">ความหนา 0.5 ซม. (ขนาด 1 ตารางเมตร)</p>
                        </div>
                        <div class="card-footer">
                        <small class="text-muted">30.00 บาท</small>
                        </div>
                    </div>
                    <div class="card">
                        <img src="img\epe-2.png" class="card-img-top " alt="...">
                        <div class="card-body">
                        <h5 class="card-title ">วัสดุกันกระแทกแบบ EPE Foam</h5>
                        <p class="card-text">ความหนา 1.0 ซม. (ขนาด 1 ตารางเมตร)</p>
                        </div>
                        <div class="card-footer">
                        <small class="text-muted">60.00 บาท</small>
                        </div>
                    </div>
                    <div class="col">
                    </div>
