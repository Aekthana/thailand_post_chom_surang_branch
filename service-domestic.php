...
<body>
    <?php 
        include("navbar.php");
    ?>
    <div class=" col-2 ps-3 mt-2 text-light " style="background-color:#EE2B47">
        <p>ไปรษณีย์ในประเทศ</p>
    </div>
    <div class="container">
        <!-- แถว1 -->
        <div class="row d-flex justify-content-center pt-2 " style="height:230px" >
            
            <div class="col-3  ms-2 p-0 r" style="height:100%">
                <div class="container-overlay">
                    <img src="img\domestic-1.jpg" class="image" alt="..." >
                    <div class="card-img-overlay d-flex justify-content-center align-items-center">
                        <h5 class="card-title text-white">ไปรษณีย์ธรรมดา</h5>
                     </div>
                    <a href="#">
                        <div class="overlay">
                            <div class="text">ไปรษณีย์ธรรมดา</div>
                        </div>
                    </a>
                </div>
            </div>
            <div class="col-3  ms-2 p-0" style="height:100%">
                <div class="container-overlay">
                    <img src="img\domestic-2.jpg" class="image" alt="..." >
                    <div class="card-img-overlay d-flex justify-content-center align-items-center">
                        <h5 class="card-title text-white">ส่งมีหลักฐาน</h5>
                     </div>
                    <a href="#">
                        <div class="overlay">
                            <div class="text">ส่งมีหลักฐาน</div>
                        </div>
                    </a>
                </div>
            </div>
            <div class="col-3  ms-2 p-0" style="height:100%">
                <div class="container-overlay">
                    <img src="img\domestic-3.jpg" class="image" alt="..." >
                    <div class="card-img-overlay d-flex justify-content-center align-items-center">
                        <h5 class="card-title text-white">ส่งด่วนพิเศษ</h5>
                     </div>
                    <a href="#">
                        <div class="overlay">
                            <div class="text">ส่งด่วนพิเศษ</div>
                        </div>
                    </a>
                </div>
            </div>
        ...
        <div class="row d-flex justify-content-center pt-2 " style="height:230px" >
            ...
            <div class="col-3  ms-2 p-0 r" style="height:100%">
                <div class="container-overlay">
                    <img src="img\domestic-4.jpg" class="image" alt="..." >
                    <div class="card-img-overlay d-flex justify-content-center align-items-center">
                        <h5 class="card-title text-white">ส่งของใหญ่</h5>
                     </div>
                    <a href="#">
                        <div class="overlay">
                            <div class="text">ส่งของใหญ่</div>
                        </div>
                    </a>
                </div>
            </div>
            <div class="col-3  ms-2 p-0" style="height:100%">
                <div class="container-overlay">
                    <img src="img\domestic-5.jpg" class="image" alt="..." >
                    <div class="card-img-overlay d-flex justify-content-center align-items-center">
                        <h5 class="card-title text-white">ส่งแผ่นพับใบปลิว</h5>
                     </div>
                    <a href="#">
                        <div class="overlay">
                            <div class="text">ส่งแผ่นพับใบปลิว</div>
                        </div>
                    </a>
                </div>
            </div>
            <div class="col-3  ms-2 p-0" style="height:100%">
                <div class="container-overlay">
                    <img src="img\domestic-6.jpg" class="image" alt="..." >
                    <div class="card-img-overlay d-flex justify-content-center align-items-center">
                        <h5 class="card-title text-white">Prompt Post</h5>
                     </div>
                    <a href="#">
                        <div class="overlay">
                            <div class="text">Prompt Post</div>
                        </div>
                    </a>
                </div>
            </div>
        ...
        <div class="row d-flex justify-content-center pt-2 " style="height:230px" >
            ...
            <div class="col-3  ms-2 p-0 r" style="height:100%">
                <div class="container-overlay">
                    <img src="img\domestic-7.jpg" class="image" alt="..." >
                    <div class="card-img-overlay d-flex justify-content-center align-items-center">
                        <h5 class="card-title text-white">บริการครบวงจร</h5>
                     </div>
                    <a href="#">
                        <div class="overlay">
                            <div class="text">บริการครบวงจร</div>
                        </div>
                    </a>
                </div>
            </div>
            <div class="col-3  ms-2 p-0" style="height:100%">
                <div class="container-overlay">
                    <img src="img\domestic-8.jpg" class="image" alt="..." >
                    <div class="card-img-overlay d-flex justify-content-center align-items-center">
                        <h5 class="card-title text-white">บริการขนส่งควบคุมอุณภูมิ</h5>
                     </div>
                    <a href="#">
                        <div class="overlay">
                            <div class="text">บริการขนส่งควบคุมอุณภูมิ</div>
                        </div>
                    </a>
                </div>
            </div>
            <div class="col-3  ms-2 p-0" style="height:100%">
                <div class="container-overlay">
                    <img src="img\domestic-9.jpg" class="image" alt="..." >
                    <div class="card-img-overlay d-flex justify-content-center align-items-center">
                        <h5 class="card-title text-white">กิจกรรมที่น่าสนใจ</h5>
                     </div>
                    <a href="#">
                        <div class="overlay">
                            <div class="text">กิจกรรมที่น่าสนใจ</div>
                        </div>
                    </a>
                </div>
            </div>
