...
<div class=" col-2 ps-5 mt-2 text-light " style="background-color:#2C2E3E">
        ...
        <div class="row d-flex justify-content-center pt-2 " style="height:230px" >
            ...
            <div class="col-3  ms-2 p-0 r" style="height:100%">
                <div class="container-overlay">
                    <img src="img\shopproduct-1.jpg" class="image" alt="..." >
                    <div class="card-img-overlay d-flex justify-content-center align-items-center">
                        <h5 class="card-title text-dark">ที่ใส่ดินสอ</h5>
                     </div>
                    <a href="shopproduct-truck.php">
                        <div class="overlay">
                            <div class="text">ที่ใส่ดินสอ</div>
                        </div>
                    </a>
                </div>
            </div>
            <div class="col-3  ms-2 p-0" style="height:100%">
                <div class="container-overlay">
                    <img src="img\shopproduct-2.jpg" class="image" alt="..." >
                    <div class="card-img-overlay d-flex justify-content-center align-items-center">
                        <h5 class="card-title text-dark">ปฏิทินตั้งโต๊ะเรซิ่น</h5>
                     </div>
                    <a href="shopproduct-resin.php">
                        <div class="overlay">
                            <div class="text">ปฏิทินตั้งโต๊ะเรซิ่น</div>
                        </div>
                    </a>
                </div>
            </div>
            <div class="col-3  ms-2 p-0" style="height:100%">
                <div class="container-overlay">
                    <img src="img\shopproduct-3.jpg" class="image" alt="..." >
                    <div class="card-img-overlay d-flex justify-content-center align-items-center">
                        <h5 class="card-title text-dark">เข็มไทร์ทรงตู้ไปรษณีย์</h5>
                     </div>
                    <a href="shopproduct-needle.php">
                        <div class="overlay">
                            <div class="text">เข็มไทร์ทรงตู้ไปรษณีย์</div>
                        </div>
                    </a>
                </div>
            </div>
    ...
    <!-- footer -->
    <div class="footer pt-4" style="background-color:#34374C;height:150px; margin-top: 110px;">
        <div class="container">
            <div class="row ">
                <div class="col-6">
