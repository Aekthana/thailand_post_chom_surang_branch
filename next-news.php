...
<head>
    ...
    <title>อ่านข่าว</title>
    <link rel="stylesheet" href="style-next-news.css">
</head>
<body>
    <?php 
         include("navbar.php");
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-12 d-flex justify-content-center">
                <img width="95%" height="252px" src="img\news-1.jpg" alt="">
            </div>
            <div class="col-12  pt-3 d-flex justify-content-center">
            <div class="col-9 ">
                <h2>หนาวนี้ที่ “น่าน” พี่ไปรฯ พาเที่ยว ชวนชิม เช็คอิน จุดเด็ดห้ามพลาดรับเดือนแห่งวันหยุด
                </h2>
                <br>
                <p>
                ก้าวสู่ปี 2565 กับการเฉลิมฉลองเทศกาลปีใหม่ ท่ามกลางบรรยากาศเย็นสบายของประเทศไทย จนทำให้ใครหลายๆ คน ต่างนึกถึงการวาร์ปไปท่องเที่ยวในพื้นที่ภาคเหนือ และเมื่อนึกถึงพื้นที่ดังกล่าว หนึ่งในจังหวัดที่น่าไปเยือนก็คงหนีไม่พ้น “จังหวัดน่าน” แลนด์มาร์คที่เต็มไปด้วยวัฒนธรรม ธรรมชาติที่สวยงาม อาหารอร่อย ๆ รวมทั้งวิถีการเดินทาง – การใช้ชีวิตแบบสโลว์ไลฟ์ แต่ด้วยความที่จังหวัดน่านมีที่เที่ยวเป็นจำนวนมาก วันนี้เราจึงชวน พี่แดง อิทธิศักดิ์ กองคำ ผู้ช่วยหัวหน้าไปรษณีย์จังหวัดน่าน มาเป็นไกด์แนะนำที่เที่ยว ร้านอาหาร และจุดเช็คอินที่ต้องห้ามพลาด <br>
                พี่แดง เล่าว่า ในช่วงฤดูหนาวโซนจังหวัดน่านเป็นพื้นที่ที่น่าเที่ยวมาก หากใครอยากเที่ยวเชิงวัฒนธรรมที่นี่มีวัดให้เดินทางไปขอพ รหลายแห่ง  หรือใครที่อยากไปสัมผัสกับวิถีทางธรรมชาติที่จังหวัดน่านก็ตอบโจทย์เพราะมีทั้งดอยที่ตอนนี้เริ่มมีที่พักให้บริการ หรือแม้แต่กระทั่งวิวท้องทุ่งที่ก็ต้องบอกว่าสวย สดชื่น สบายตาติดอันดับท็อป ๆ ของประเทศ สในฐานะที่เป็นคนพื้นที่สถานที่แรกที่อยากแนะนำนักท่องเที่ยวก็คือ บ่อเกลือสินเธาว์โบราณ - ถนนหมายเลข 3 - สะปัน จุดท็อปฮิตของคนรักธรรมชาติ ซึ่งเป็นบ่อเกลือสินเธาว์แห่งเดียวของโลก ที่มีเรื่องราวและเคล็บลับการผลิตเกลือด้วยภูมิปัญญาของคนท้องถิ่นที่ถ่ายทอดกันมากว่า 700 ปี โดยคุณแดงเล่าเสริมว่า คนที่จะผลิตเกลือของที่นี่จะเป็นบุคคลที่ต้องเคยผ่านพิธีบวงสรวงขออนุญาตเจ้าที่และสิ่งศักดิ์สิทธิ์มาแล้วเท่านั้น ดังนั้นจึงไม่สามารถให้นักท่องเที่ยวได้ทดลองเวิร์ค ช็อปการทำเกลือได้ แต่ก็ยังมีการแสดงพื้นบ้านเกี่ยวกับวิธีการต้มเกลือสินเธาว์ให้ได้รับชม และผลิตภัณฑ์แปรรูปจากเกลือมากมายให้ได้เลือกซื้อ ซึ่งจะช่วยสร้างความเพลิดเพลินในการมาท่องเที่ยวที่นี่ได้ไม่แพ้กัน<br>หลังจากทัวร์บ่อเกลือกันแล้ว ออกมาที่ถนนสายหลักเราก็จะพบกับจุดชมวิว “ถนนหมายเลข 3” ที่เป็นเส้นเดียวกับบ่อเกลือ โดยคุณแดงเล่าว่า จุดนี้เปรียบเสมือนแลนด์มาร์คของอำเภอบ่อเกลือเลยทีเดียว เพราะในระยะหลังนี้ ถนนดังกล่าวได้กลายเป็นจุดชมวิวที่นักท่องเที่ยวนิยมจอดรถเพื่อเก็บภาพอย่างคึกคัก เนื่องจากสองข้างทางที่ประกอบด้วยแนวต้นไม้สีเขียวที่ยกระดับถนนให้ไล่ขึ้นตามแนวภูเขา ทำให้สามารถมองเห็นและถ่ายภาพออกมาเป็นเลขสามได้ ทั้งนี้ ในส่วนของบรรยากาศ ก็มีความร่มรื่นรวมถึงมีจุดเช็คอินกับหลักกิโลและวิวภูเขาสุดอลังการให้ได้ดื่มด่ำกับบรรยากาศเช่นเดียวกัน
                <br>
                ...
                <p>
                <br>จบจากทัวร์ธรรมชาติกันแล้ว ก็เดินทางไปรับพลังบุญต่อกันที่ “พระมหาเจดีย์ พระพุทธเจ้า5พระองค์ บ้านเมตตาธรรม” สถานที่ปฏิบัติธรรมที่ขึ้นชื่อเรื่องความศักดิ์สิทธิ์เป็นอย่างมากแม้จะเพิ่งดำเนินการก่อสร้างได้ไม่นาน โดยปัจจุบันแม้จะยังก่อสร้างได้ไม่เสร็จ100% แต่ก็ยังมีความสวยงามโอ่อ่า และเปิดรับนักท่องเที่ยว รวมถึงผู้ที่ต้องการมาวิปัสนาให้ได้เข้ามาบำเพ็ญธรรมกัน และพาไปต่อที่ “วัดก๋ง” หรือ “วัดศรีมงคล” อำเภอท่าวังผา ที่บรรยากาศโดยรอบของวัดจะมีการตกแต่งแบบล้านนา รวมถึงมีกระท่อมไม้ไผ่ที่มีข้าวของเครื่องใช้แบบโบราณ 
                <br>มื่ออิ่มเอมกับวิวธรรมชาติและไหว้พระขอพรรอบจังหวัดน่านเพื่อเสริมสิริมงคลรับปีใหม่แล้ว พี่แดงยังชวนมาอิ่มท้องที่ร้านอาหารขึ้นชื่ออย่าง ร้านขนมจีนน้ำเงี๊ยว ข้าวซอยแม่สุณี โดยขนมจีนถือหนึ่งในอาหารมงคล ตามความเชื่อที่ว่ากินแล้วจะอายุยืนยาวเหมือนเส้นขนมจีน ซึ่งเมื่อพี่แดงว่างเว้นจากการเป็นพี่ไปรฯ ที่ส่งต่อสิ่งของให้กับพี่น้องชาวน่านแล้ว ก็จะมารับหน้าที่ส่งต่อความอร่อยให้กับทุกคนอย่างจุใจแน่นอน เป็นอีกงานที่พี่แดงรักและตั้งใจเต็มที่ และแอบได้ยินมาว่าร้านนี้เป็นร้านของภรรยาพี่แดงนั่นเอง!
