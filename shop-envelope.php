        ...
        <div class="row">
            ...
            <div class="col-12">
                <div class="card-group">
                    <div class="card">
                        <img src="img\envelope-1.jpg" class="card-img-top" alt="...">
                        <div class="card-body">
                        <h5 class="card-title">ซอง ซี 6 สีขาว <br> Envelope C6 White</h5>
                        <p class="card-text">114 x 162 มม./mm.</p>
                        </div>
                        <div class="card-footer">
                        <small class="text-muted">3 ซอง ราคา 2.00 บาท</small>
                        </div>
                    </div>
                    <div class="card">
                        <img src="img\envelope-2.jpg" class="card-img-top" alt="...">
                        <div class="card-body">
                        <h5 class="card-title">ซอง ซี 6 ชนิดสี <br> Envelope C6 color</h5>
                        <p class="card-text">114 x 162 มม./mm</p>
                        </div>
                        <div class="card-footer">
                        <small class="text-muted">1.00 บาท</small>
                        </div>
                    </div>
                    <div class="card">
                        <img src="img\envelope-3.jpg" class="card-img-top pt-5" alt="...">
                        <div class="card-body">
                        <h5 class="card-title">ซอง ซี 6 ชนิดสีแบบแพค (1 แพคมี 10 ซอง)<br> Envelope C6 color Pack <br>( 1 Pack = 10Envelopes)</h5>
                        <p class="card-text">114 x 162 มม./mm.</p>
                        </div>
                        <div class="card-footer">
                        <small class="text-muted">8.00 บาท</small>
                        </div>
                    </div>
                    <div class="card">
                        <img src="img\envelope-4.jpg" class="card-img-top" alt="...">
                        <div class="card-body">
                        <h5 class="card-title">ซองขนาด ดีแอล <br>Envelope DL
                        </h5>
                        <p class="card-text">110 x 220 มม./mm. </p>
                        </div>
                        <div class="card-footer">
                        <small class="text-muted">1.50 บาท</small>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12">
                <div class="card-group">
                    <div class="card">
                        <img src="img\envelope-5.jpg" class="card-img-top" alt="...">
                        <div class="card-body">
                        <h5 class="card-title">ซองอากาศ DL <br>International Envelope DL</h5>
                        <p class="card-text">110 x 220 มม./mm.</p>
                        </div>
                        <div class="card-footer">
                        <small class="text-muted">1.50  บาท</small>
                    ...
                    <div class="card">
                        <img src="img\envelope-6.jpg" class="card-img-top" alt="...">
                        <div class="card-body">
                        <h5 class="card-title">ซอง ซี 5 สีครีม <br>Envelope C5 Cream-Colored</h5>
                        <p class="card-text">162 x 229 มม./mm</p>
                        </div>
                        <div class="card-footer">
                        <small class="text-muted">3.00 บาท</small>
                        </div>
                    </div>
                    <div class="card">
                        <img src="img\envelope-7.jpg" class="card-img-top" alt="...">
                        <div class="card-body">
                        <h5 class="card-title">ซอง ซี 4 สีครีม<br>Envelope C4 Cream-Colored</h5>
                        <p class="card-text">229 x 324 มม./mm.</p>
                        </div>
                        <div class="card-footer">
                        <small class="text-muted">4.00 บาท</small>
                        </div>
                    </div>
                    <div class="card">
                        <img src="img\envelope-8.jpg" class="card-img-top" alt="...">
                        <div class="card-body">
                        <h5 class="card-title ">ซองขยายข้าง ซี 4 <br>Expended size Envelopes C4
                        </h5>
                        <p class="card-text">229 x 324 มม./mm.</p>
                        </div>
                        <div class="card-footer">
                        <small class="text-muted">5.00 บาท</small>
                        </div>
                    </div>
                </div>
            </div>
