...
<div class=" col-2 ps-5 mt-2 text-light " style="background-color:#2C2E3E">
        <p>กล่อง/ซอง</p>
    </div>
    <div class="container">
        <!-- แถว1 -->
        <div class="row d-flex justify-content-center pt-2 " style="height:230px" >
            ...
            <div class="col-3  ms-2 p-0 r" style="height:100%">
                <div class="container-overlay">
                    <img src="img\shop-1.jpg" class="image" alt="..." >
                    <div class="card-img-overlay d-flex justify-content-center align-items-center">
                        <h5 class="card-title text-dark">ซองจดหมาย</h5>
                     </div>
                    <a href="shop-envelope.php">
                        <div class="overlay">
                            <div class="text">ซองจดหมาย</div>
                        </div>
                    </a>
                </div>
            </div>
            <div class="col-3  ms-2 p-0" style="height:100%">
                <div class="container-overlay">
                    <img src="img\shop-2.jpg" class="image" alt="..." >
                    <div class="card-img-overlay d-flex justify-content-center align-items-center">
                        <h5 class="card-title text-dark">กล่องสำเร็จรูป</h5>
                     </div>
                    <a href="shop-box.php">
                        <div class="overlay">
                            <div class="text">กล่องสำเร็จรูป</div>
                        </div>
                    </a>
                </div>
            </div>
            <div class="col-3  ms-2 p-0" style="height:100%">
                <div class="container-overlay">
                    <img src="img\shop-3.jpg" class="image" alt="..." >
                    <div class="card-img-overlay d-flex justify-content-center align-items-center">
                        <h5 class="card-title text-dark">กล่องธรรมดา</h5>
                     </div>
                    <a href="shop-boxoriginal.php">
                        <div class="overlay">
                            <div class="text">กล่องธรรมดา</div>
                        </div>
                    </a>
                </div>
            </div>
        ...
        <div class="row d-flex justify-content-center pt-2 " style="height:230px" >
            ...
            <div class="col-3  ms-2 p-0 r" style="height:100%">
                <div class="container-overlay">
                    <img src="img\shop-4.jpg" class="image" alt="..." >
                    <div class="card-img-overlay d-flex justify-content-center align-items-center">
                        <h5 class="card-title text-dark">ซองกันกระแทก</h5>
                     </div>
                    <a href="shop-padded-envelope.php">
                        <div class="overlay">
                            <div class="text">ซองกันกระแทก</div>
                        </div>
                    </a>
                </div>
            </div>
            <div class="col-3  ms-2 p-0" style="height:100%">
                <div class="container-overlay">
                    <img src="img\shop-5.jpg" class="image" alt="..." >
                    <div class="card-img-overlay d-flex justify-content-center align-items-center">
                        <h5 class="card-title text-dark">วัสดุกันกระแทกแบบ EPE Foam</h5>
                     </div>
                    <a href="shop-epe.php">
                        <div class="overlay">
                            <div class="text">วัสดุกันกระแทกแบบ EPE Foam</div>
                        </div>
                    </a>
                </div>
            </div>
