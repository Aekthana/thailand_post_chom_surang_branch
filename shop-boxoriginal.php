        ...
        <div class="row">
            ...
            <div class="col-12">
                <div class="card-group">
                    <div class="card">
                        <img src="img\box-o-1.jpg" class="card-img-top pt-5 pb-3" alt="...">
                        <div class="card-body">
                        <h5 class="card-title">กล่องธรรมดา หมายเลข 1 <br> Normal Carton No.1</h5>
                        <p class="card-text">30 x 100 x 30 ซม./ cm.</p>
                        </div>
                        <div class="card-footer">
                        <small class="text-muted">35.00 บาท</small>
                        </div>
                    </div>
                    <div class="card">
                        <img src="img\box-o-2.jpg" class="card-img-top" alt="...">
                        <div class="card-body">
                        <h5 class="card-title">กล่องธรรมดา หมายเลข 2 <br> Normal Carton No.2</h5>
                        <p class="card-text">31 x 36 x 13 ซม./ cm. </p>
                        </div>
                        <div class="card-footer">
                        <small class="text-muted">20.00 บาท</small>
                        </div>
                    </div>
                    <div class="card">
                        <img src="img\box-o-3.jpg" class="card-img-top pb-2" alt="...">
                        <div class="card-body">
                        <h5 class="card-title">กล่องธรรมดา หมายเลข 3<br> Normal Carton No.3</h5>
                        <p class="card-text">31 x 36 x 26 ซม./ cm. </p>
                        </div>
                        <div class="card-footer">
                        <small class="text-muted">37.00 บาท</small>
                        </div>
                    </div>
                    <div class="card">
                        <img src="img\box-o-4.jpg" class="card-img-top pb-4 pt-2" alt="...">
                        <div class="card-body">
                        <h5 class="card-title">กล่องธรรมดา หมายเลข 4<br> Normal Carton No.4
                        </h5>
                        <p class="card-text">55 x 100 x 55 ซม./ cm.</p>
                        </div>
                        <div class="card-footer">
                        <small class="text-muted">105.00 บาท</small>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12">
                <div class="card-group">
                    <div class="card">
                        <img src="img\box-o-5.png" class="card-img-top" alt="...">
                        <div class="card-body">
                        <h5 class="card-title">กล่องธรรมดา หมายเลข 5 <br>Normal Carton No.5</h5>
                        <p class="card-text">40 x 45 x 35 ซม./ cm.  </p>
                        </div>
                        <div class="card-footer">
                        <small class="text-muted">40.00 บาท</small>
                        </div>
                    </div>
                    <div class="card">
                        <img src="img\box-o-6.jpg" class="card-img-top pt-3" alt="...">
                        <div class="card-body">
                        <h5 class="card-title">กล่องธรรมดา หมายเลข 6<br>Normal Carton No.6</h5>
                        <p class="card-text">45 x 55 x 40 ซม./ cm.</p>
                        </div>
                        <div class="card-footer">
                        <small class="text-muted">55.00 บาท</small>
                        </div>
                    </div>
                    <div class="col">
