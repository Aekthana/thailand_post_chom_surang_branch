...
<head>
    ...
    <title>ปฏิทินตั้งโต๊ะเรซิ่นทรงตู้ไปรษณีย์</title>
</head>
<body>
    <?php 
        include("navbar.php")
    ?>
        ...
        <div class="row pt-4">
            <div class="col-12">
                ...
                ปฏิทินตั้งโต๊ะเรซิ่นทรงตู้ไปรษณีย์ 
                </h5>
            </div>
        </div>
        <div class="row">
            ...
            <div class="col-12">
                <div class="card-group">
                    <div class="card">
                        <img src="img\resin-1.jpg" class="card-img-top " alt="...">
                        <div class="card-body">
                        <h5 class="card-title">ปฏิทินตั้งโต๊ะเรซิ่นทรงตู้ไปรษณีย์ <br>(Postbox Resin Calendar)</h5>
                        </div>
                        <div class="card-footer">
                        <small class="text-muted">120.00 บาท</small>
                        </div>
                    </div>
                    <div class="col">
                    </div>
