...
<head>
    ...
    <title>ตู้รับไปรษณียภัณฑ์ประจำบ้าน</title>
</head>
<body>
    <?php 
        include("navbar.php")
        ...
        <div class="row">
            ...
            <div class="col-12">
                <div class="card-group">
                    <div class="card">
                        <img src="img\boxbox-1.jpg" class="card-img-top pt-5 pb-5" alt="...">
                        <div class="card-body">
                        <h5 class="card-title pt-5">ตู้พลาสติก <br>( Plastic Post Boxes )</h5>
                        <p class="card-text">28 x 24 x 12 ซม./cm.</p>
                        </div>
                        <div class="card-footer">
                        <small class="text-muted">300.00 บาท</small>
                        </div>
                    </div>
                    <div class="card">
                        <img src="img\boxbox-2.jpg" class="card-img-top " alt="...">
                        <div class="card-body">
                        <h5 class="card-title ">ตู้โลหะ <br>( Metal Post Boxes )</h5>
                        <p class="card-text">23 x 10 x 34 ซม./cm. </p>
                        </div>
                        <div class="card-footer">
                        <small class="text-muted">600.00 บาท</small>
                        </div>
                    </div>
                    <div class="col">
                    </div>
