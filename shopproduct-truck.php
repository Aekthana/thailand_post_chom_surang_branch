...
<head>
    ...
    <title>ที่ใส่ดินสอทรงรถขนส่งไปรษณีย</title>
</head>
<body>
    <?php 
        include("navbar.php")
        ...
        <div class="row">
            ...
            <div class="col-12">
                <div class="card-group">
                    <div class="card">
                        <img src="img\truck-1.jpg" class="card-img-top " alt="...">
                        <div class="card-body">
                        <h5 class="card-title">ที่ใส่ดินสอทรงรถขนส่งไปรษณีย <br>(Mail Truck Stationery)</h5>
                        </div>
                        <div class="card-footer">
                        <small class="text-muted">200.00 บาท</small>
                        </div>
                    </div>
                    <div class="col">
                    </div>
