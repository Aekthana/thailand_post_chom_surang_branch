...
<div class=" col-2 ps-5 mt-2 text-light " style="background-color:#2C2E3E">
        ...
        <div class="row d-flex justify-content-center pt-2 " style="height:230px" >
            ...
            <div class="col-3  ms-2 p-0 r" style="height:100%">
                <div class="container-overlay">
                    <img src="img\shopbox.jpg" class="image" alt="..." >
                    <div class="card-img-overlay d-flex justify-content-center align-items-center">
                        <h5 class="card-title text-dark">ตู้รับไปรษณียภัณฑ์ประจำบ้าน</h5>
                     </div>
                    <a href="shopbox-box.php">
                        <div class="overlay">
                            <div class="text">ตู้รับไปรษณียภัณฑ์ประจำบ้าน</div>
                        </div>
                    </a>
                </div>
            </div>
    ...
    <!-- footer -->
    <div class="footer pt-4" style="background-color:#34374C;height:150px; margin-top: 120px;">
        <div class="container">
            <div class="row ">
                <div class="col-6">
