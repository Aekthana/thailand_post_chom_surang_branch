...
<head>
    ...
    <title>เข็มไทร์ทรงตู้ไปรษณีย์</title>
</head>
<body>
    <?php 
        include("navbar.php")
        ...
        <div class="row">
            ...
            <div class="col-12">
                <div class="card-group">
                    <div class="card">
                        <img src="img\nigle-1.jpg" class="card-img-top pt-5" alt="...">
                        <div class="card-body">
                        <h5 class="card-title">เข็มไทร์ทรงตู้ไปรษณีย์ <br> (นิเกิลเงา)  <br> Postbox Tie Pin</h5>
                        </div>
                        <div class="card-footer">
                        <small class="text-muted">45.00 บาท</small>
                        </div>
                    </div>
                    <div class="card">
                        <img src="img\nigle-1.jpg" class="card-img-top pt-5" alt="...">
                        <div class="card-body">
                        <h5 class="card-title">เข็มไทร์ทรงตู้ไปรษณีย์ <br> (ทองเงา) <br> Postbox Tie Pin</h5>
                        </div>
                        <div class="card-footer">
                        <small class="text-muted">50.00 บาท</small>
                        </div>
                    </div>
                    <div class="col">
                    </div>
